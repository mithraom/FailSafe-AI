...
Streamlit App: https://failsafe-ai.streamlit.app/

Installation and Setup
git clone https://github.com/mithraom/FailSafe-AI
cd failsafe-ai
pip install -r requirements.txt
streamlit run app.py

Use Cases
Startup founders evaluating financial sustainability
Investors assessing portfolio risk exposure
FinTech platforms exploring risk-sharing models
Academic and research applications in predictive analytics
